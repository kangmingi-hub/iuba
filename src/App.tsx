...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-white font-sans p-4 md:p-8" style={{ position: 'relative', zIndex: 1, background: 'linear-gradient(135deg, #050d1a 0%, #0a1628 50%, #050d1a 100%)' }}>
      <HologramBackground /> 
