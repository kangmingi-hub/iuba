    ...
    <AnimatePresence>
      {isVisible && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="absolute" style={{ width: '600px', height: '600px', borderRadius: '50%', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'radial-gradient(circle, rgba(99,179,237,0.12) 0%, transparent 70%)' }} />
            <div className="absolute" style={{ width: '800px', height: '800px', borderRadius: '50%', top: '-200px', left: '50%', transform: 'translateX(-50%)', border: '1px solid rgba(99,179,237,0.08)' }} />
            <div className="absolute" style={{ width: '600px', height: '600px', borderRadius: '50%', bottom: '-150px', left: '50%', transform: 'translateX(-50%)', border: '1px solid rgba(139,92,246,0.07)' }} />
            <div className="absolute inset-0" style={{ backgroundImage: `linear-gradient(rgba(99,179,237,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(99,179,237,0.04) 1px, transparent 1px)`, backgroundSize: '60px 60px' }} />
          </motion.div>
          ...
          >
            <div className="w-20 h-20 rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-xl"
              style={{ background: 'rgba(59,130,246,0.85)', boxShadow: '0 8px 32px rgba(59,130,246,0.3)', backdropFilter: 'blur(8px)' }}
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="text-left">
                ...
                <input
                  ...
                  style={{ background: 'rgba(255,255,255,0.55)', border: '1px solid rgba(255,255,255,0.75)', backdropFilter: 'blur(8px)' }}
                />
              </div>
              <div className="text-left">
                <label className="block text-[10px] font-extrabold text-slate-500 mb-2 uppercase tracking-widest ml-4">비밀번호</label>
                <input
                  type="password"
                  value={loginPassword}
